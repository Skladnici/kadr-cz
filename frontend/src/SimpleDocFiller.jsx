...
export default function SimpleDocFiller() {
  ...
  // exactly the same field-extraction and auto-fill logic as a photo. The
  // actual per-document reconciliation (which file's name/doc-number
  // "wins") lives in utils/recognizeMerge.js, shared with batch mode's
  // per-person recognition — this just applies the merged result to this
    ...
    >
      <div className="w-full max-w-xl md:max-w-2xl">
        ...
        <p className="mt-[22px] text-center text-[11.5px] text-slate-400">
          ...
          mzda, adresa) se neukládají — mažou se hned po stažení. PSČ, které
          nejde doplnit ze seznamu měst, se dohledává podle zadané adresy
